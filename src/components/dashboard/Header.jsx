...
const Header = ({
  ...
  className={`appearance-none ${darkMode ? 'bg-gray-700 border-gray-600 text-white' : 'bg-white border-gray-300 text-gray-900'} 
...
>
              ...
              <ChevronDown
                ...
                } w-4 h-4 absolute right-3 top-1/2 transform -translate-y-1/2 pointer-events-none`}
              />
            </div>
          </div>
