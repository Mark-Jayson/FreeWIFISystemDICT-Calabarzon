          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative ml-8">
              <select 
                ...
                className="appearance-none bg-white border-gray-300 text-gray-900 border rounded-xl px-4 py-2 pr-10 text-sm font-medium focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
              >
