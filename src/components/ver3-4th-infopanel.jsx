  ...
  { 
    ...
    siteLocations: [
      ...
      { 
        ...
        type: "SUC Main",
        locID: "L3-4336",
        address: "National Highway, Sto. Tomas, Batangas City, BATANGAS",
        flcacArea: false,
        notCIDA: true,
        apSites: [
          {
  ...
  { 
    ...
    siteLocations: [
      { 
        ...
        type: "SUC Main",
        locID: "L3-4337",
        address: "Rizal Avenue, Sto. Tomas, BATANGAS",
        flcacArea: true,
        notCIDA: false,
        apSites: [
          {
...
const APSiteDetailsModal = ({ apSite, onClose }) => {
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-xl shadow-lg p-4 w-80 max-h-[90vh] overflow-auto">
