...
// Updated InfoPanel component with modal moved outside the panels container
const InfoPanel = () => {
  ...
  return (
    <div className="w-full h-screen bg-gray-100 flex justify-center items-center">
      ...
      {/* Modal component moved outside the panels container */}
      {selectedApSite && (
        <APSiteDetailsPopup 
          site={selectedApSite}
...
// AP Site Details Popup - Redesigned and positioned outside panel container
const APSiteDetailsPopup = ({ site, onClose }) => {
  if (!site) return null;
  
  return (
    <div className="fixed inset-0 bg-gray-900 bg-opacity-50 z-50 flex items-center justify-center overflow-y-auto overflow-x-hidden" onClick={onClose}>
      <div 
      ...
      >
        ...
        <div className="relative bg-white rounded-lg shadow">
          ...
          <div className="p-4">
            <div className="mb-4">
              <div className="text-sm font-medium text-gray-500">AP Site Name</div>
              <div className="flex items-center mt-1">
                <div className={`h-3 w-3 rounded-full mr-2 ${site.status === 'active' ? 'bg-green-500' : 'bg-red-500'}`}></div>
                <div className="text-base font-bold text-gray-900">{site.name}</div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-x-6 gap-y-4">
              <div>
                ...
                <div className="text-sm font-semibold text-gray-800 mt-1">{site.location || "Batangas State University - Alangilan"}</div>
              </div>
              
              <div>
                <div className="text-sm font-medium text-gray-500">Technology</div>
                <div className="text-sm font-semibold text-gray-800 mt-1">{site.technology || site.led}</div>
              </div>
              
              <div>
                <div className="text-sm font-medium text-gray-500">Procurement</div>
                <div className="text-sm font-semibold text-gray-800 mt-1">{site.procurement || "Central"}</div>
              </div>
              
              <div>
                <div className="text-sm font-medium text-gray-500">CMS Provider</div>
                <div className="text-sm font-semibold text-gray-800 mt-1">{site.cmsProvider || "HTECH Inc."}</div>
              </div>
              
              <div>
                <div className="text-sm font-medium text-gray-500">Link Provider</div>
                <div className="text-sm font-semibold text-gray-800 mt-1">{site.linkProvider || "Converge Technologies"}</div>
              </div>
              
              <div>
                <div className="text-sm font-medium text-gray-500">Bandwidth</div>
                <div className="text-sm font-semibold text-gray-800 mt-1">{site.bandwidth || `${site.mbps} MB/S`}</div>
              </div>
              
              <div>
                <div className="text-sm font-medium text-gray-500">Project</div>
                <div className="text-sm font-semibold text-gray-800 mt-1">{site.project || "DICT Calabarzon"}</div>
              </div>
              
              <div>
                <div className="text-sm font-medium text-gray-500">Contract Status</div>
                <div className="text-sm font-semibold text-gray-800 mt-1">{site.contractStatus || "Active"}</div>
              </div>
              
              <div>
                <div className="text-sm font-medium text-gray-500">Activation Date</div>
                <div className="text-sm font-semibold text-gray-800 mt-1">{site.activationDate || "January 3, 2022"}</div>
              </div>
              
              <div>
                <div className="text-sm font-medium text-gray-500">End of Contract</div>
                <div className="text-sm font-semibold text-gray-800 mt-1">{site.endOfContract || "March 30, 2028"}</div>
              </div>
            </div>
          </div>
